...
export default function GrainFoodProduct() {
    ...
    >
                ...
                <div className="relative pb-[50px] max-w-[1400px]  mx-auto rounded-[40px] pt-[150px] bg-white w-full">
                    ...
                    <div className="mb-[30px] text-center">
                        ...
                        <div className="w-fit mx-auto items-center gap-2 bg-gradient-to-r from-orange-100 to-yellow-100 text-orange-800 px-4 py-[6px] rounded-full text-xs font-medium tracking-wide shadow-sm">
                            🌾 Wholesome • Natural • Nutrient-Rich
                        </div>
                        ...
                        <h1 className="mt- text-[30px] md:text-[36px] font-bold text-gray-900 tracking-tight relative inline-block">
                            ...
                            <span className="absolute left-1/2 -bottom-2 w-[60%] h-[3px] bg-gradient-to-r from-orange-500 to-yellow-400 rounded-full -translate-x-1/2"></span>

                        </h1>

                        <p className="text-[14px] text-gray-500 mt-4 mx-auto max-w-[520px] leading-relaxed">
                            Made from carefully selected natural grains, our products are rich in nutrition, purity, and taste — supporting a healthy and balanced lifestyle.
                        </p>
  ...
  <div className="max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    >
      ...
      />
                    ...
                    <main className="w-[100%] pt-10 md:px-0 px-[15px]  overflow-auto">
                            ...
                            <div className=" md:w-[97%] 2xl:w-[100%]   mx-auto">
                                {filteredCakes.length > 0 ? (
                                    <motion.div
                                        ...
                                        className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5  gap-x-4 gap-y-[20px] md:gap-y-[40px] pb-[40px] "
                                    >
