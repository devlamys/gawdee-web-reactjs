...
export default function HelthWellnessProduct() {
...
<div className="mb-[30px] text-center">
  ...
  <div className="w-fit mx-auto items-center gap-2 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 px-4 py-[6px] rounded-full text-xs font-medium tracking-wide shadow-sm">
    🌿 Health • Wellness • Natural Living
  </div>

  <h1 className="mt- text-[30px] md:text-[36px] font-bold text-gray-900 tracking-tight relative inline-block">

    Gawdee Wellness Range

    <span className="absolute left-1/2 -bottom-2 w-[60%] h-[3px] bg-gradient-to-r from-green-600 to-emerald-400 rounded-full -translate-x-1/2"></span>

  </h1>

  <p className="text-[14px] text-gray-500 mt-4 mx-auto max-w-[520px] leading-relaxed">
    Nourish your body with natural, wholesome products crafted to support a healthier lifestyle — pure, chemical-free, and rooted in tradition.
  </p>
  ...
  <div className="max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    >
      ...
      />
                    ...
                    <main className="w-[100%] md:pt-10 px-[15px] md:px-0 overflow-auto">
